...
class Crash extends Command {
    ...
    async execute(interaction, client, lng) {
        ...
        if (money > data.currency) return await interaction.editReply({ content: `Vous ne pouvez pas misez plus que ce que vous possèdez. (*Solde: ${data.currency}* coins)`, ephemeral: true });
